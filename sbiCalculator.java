...
public class sbiCalculator {
	...
	public static void main(String[] args) {
		...
		//find the tenure
		WebElement tenure = driver.findElement(By.xpath("html/body/div[1]/div[4]/div[2]/div[2]/table/tbody/tr/td[2]/div/div[2]/div/div/div/div[1]/div/form/table/tbody/tr[2]/td[1]/p[2]/input"));
		//enter the tenure
		
		tenure.sendKeys("60");
		
		//Find the calculate button
		WebElement calc = driver.findElement(By.xpath("html/body/div[1]/div[4]/div[2]/div[2]/table/tbody/tr/td[2]/div/div[2]/div/div/div/div[1]/div/form/table/tbody/tr[3]/td/p/input[1]"));
