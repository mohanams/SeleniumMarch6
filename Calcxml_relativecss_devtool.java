...
public class Calcxml_relativecss_devtool {
...
FirefoxDriver driver = new FirefoxDriver();
		...
		WebElement loan = driver.findElement(By.cssSelector("#loanAmount"));
		...
		//find the tenure
		WebElement tenure = driver.findElement(By.cssSelector("#termMonths"));
		//Enter the tenure
		tenure.clear();
		tenure.sendKeys("60");
